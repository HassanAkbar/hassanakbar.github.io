...
define('blinklist/tests/integration/components/books-listing-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | books-listing', function (hooks) {
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "cGU8shYS",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"books-listing\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "zKGxSla+",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"books-listing\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('blinklist/tests/integration/components/categories-listing-test', ['qunit', 'ember-qunit', '@ember/test-helpers'], function (_qunit, _emberQunit, _testHelpers) {
  'use strict';

  (0, _qunit.module)('Integration | Component | categories-listing', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    ...
    (0, _qunit.test)('it renders', async function (assert) {
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "OVAgOG6h",
        "block": "{\"symbols\":[],\"statements\":[[1,[21,\"categories-listing\"],false]],\"hasEval\":false}",
        "meta": {}
      }));
      ...
      await (0, _testHelpers.render)(Ember.HTMLBars.template({
        "id": "dgdZPIlH",
        "block": "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"categories-listing\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
        "meta": {}
      }));
...
define('blinklist/tests/lint/app.lint-test', [], function () {
  'use strict';
  ...
  QUnit.test('components/books-listing.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/books-listing.js should pass ESLint\n\n');
  });

  QUnit.test('components/categories-listing.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/categories-listing.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('controllers/categories.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/categories.js should pass ESLint\n\n');
  });

  QUnit.test('controllers/category.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/category.js should pass ESLint\n\n');
  });

  QUnit.test('mixins/requestable.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'mixins/requestable.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('routes/category.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/category.js should pass ESLint\n\n');
  });
...
define('blinklist/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('blinklist/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'blinklist/templates/application.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('blinklist/templates/book.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'blinklist/templates/book.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('blinklist/templates/books.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'blinklist/templates/books.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('blinklist/templates/categories.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'blinklist/templates/categories.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('blinklist/templates/category.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'blinklist/templates/category.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('blinklist/templates/components/books-listing.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'blinklist/templates/components/books-listing.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('blinklist/templates/components/categories-listing.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'blinklist/templates/components/categories-listing.hbs should pass TemplateLint.\n\n');
  });
});
define('blinklist/tests/lint/tests.lint-test', [], function () {
  'use strict';

  QUnit.module('ESLint | tests');

  QUnit.test('integration/components/books-listing-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/books-listing-test.js should pass ESLint\n\n');
  });

  QUnit.test('integration/components/categories-listing-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/categories-listing-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/controllers/categories-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/categories-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/controllers/category-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/category-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/mixins/requestable-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/mixins/requestable-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/routes/categories-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/categories-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/category-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/category-test.js should pass ESLint\n\n');
  });
...
define('blinklist/tests/test-helper', ['blinklist/app', 'blinklist/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
define('blinklist/tests/unit/controllers/application-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
  ...
  (0, _qunit.module)('Unit | Controller | application', function (hooks) {
    ...
    (0, _qunit.test)('user service exists exists', function (assert) {
...
define('blinklist/tests/unit/controllers/book-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
  ...
  (0, _qunit.module)('Unit | Controller | book', function (hooks) {
    ...
    (0, _qunit.test)('user service exists', function (assert) {
      let controller = this.owner.lookup('controller:book');
      assert.ok(controller.user);
      assert.equal(controller.user.userId, null);
      assert.equal(controller.user.accessType, null);
...
define('blinklist/tests/unit/controllers/categories-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Controller | categories', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('blinklist/tests/unit/controllers/category-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Controller | category', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('blinklist/tests/unit/mixins/requestable-test', ['blinklist/mixins/requestable', 'qunit'], function (_requestable, _qunit) {
  'use strict';

  (0, _qunit.module)('Unit | Mixin | requestable', function () {
    // Replace this with your real tests.
    (0, _qunit.test)('it works', function (assert) {
      let RequestableObject = Ember.Object.extend(_requestable.default);
      let subject = RequestableObject.create();
      assert.ok(subject);
    });
  });
});
define('blinklist/tests/unit/routes/application-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('blinklist/tests/unit/routes/book-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('blinklist/tests/unit/routes/books-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('blinklist/tests/unit/routes/categories-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Route | categories', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('blinklist/tests/unit/routes/category-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('blinklist/tests/unit/services/current-user-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
require('blinklist/tests/test-helper');
